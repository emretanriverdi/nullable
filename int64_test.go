...
func TestUnmarshalNonInt64Number(t *testing.T) {
	var i Int64
...
func TestInt64Equal(t *testing.T) {
	int641 := NewInt64(10, false)
	int642 := NewInt64(10, false)
	assertInt64EqualIsTrue(t, int641, int642)

	int641 = NewInt64(10, false)
	int642 = NewInt64(20, false)
	assertInt64EqualIsTrue(t, int641, int642)

	int641 = NewInt64(10, true)
	int642 = NewInt64(10, true)
	assertInt64EqualIsTrue(t, int641, int642)

	int641 = NewInt64(10, true)
	int642 = NewInt64(10, false)
	assertInt64EqualIsFalse(t, int641, int642)
